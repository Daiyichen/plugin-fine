...
public class ThemeSimple extends AbstractThemeVariousProvider {
	...
	public static final FunctionProcessor ONEFUNCTION = new AbstractFunctionProcessor(){
	    ...
	    public String getLocaleKey() {
	        return "plugin-theme-simple";//使用国际化的时候直接返回国际化字符串即可
	    }
	};
    ...
    public String coverPath() {
    	PluginLicense pluginLicense = PluginLicenseManager.getInstance().getPluginLicenseByID(Constants.PLUGIN_ID);
        if (pluginLicense.isAvailable()) {
          	return "/com/fr/solution/theme/simple/files/cover.png";
        } else {
            return "";
        }
    ...
    public String scriptPath() {
        ...
        PluginLicense pluginLicense = PluginLicenseManager.getInstance().getPluginLicenseByID(Constants.PLUGIN_ID);
        if (pluginLicense.isAvailable()) {
            return "/com/fr/solution/theme/simple/files/theme.js";
        } else {
            return "";
        }
    }
    ...
    public String stylePath() {
        PluginLicense pluginLicense = PluginLicenseManager.getInstance().getPluginLicenseByID(Constants.PLUGIN_ID);
        if (pluginLicense.isAvailable()) {
            return "/com/fr/solution/theme/simple/files/style.css";
        } else {
            return "";
        }
    }
